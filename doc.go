...
certain procedures:
  ...
  - Password integrity is checked via ReasonablePassword() in
...
you can see in its documentation. The fields are as follows:
  ...
  - PasswordNames: A list of strings to be excluded from passwords. This is
    ...
    application. It will be passed to ReasonablePassword() in
    github.com/rivo/sessions.
...
Users have an ID which must be unique (e.g. generated by CUID() in
